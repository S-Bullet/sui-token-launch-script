...
// https://sui-miannet-endpoint.blockvision.org
// https://cetus-miannet-endpoint.blockvision.org
// https://mainnet.suit.app
// https://sui-mainnet.blastapi.io/5e2b3e4f-dc83-432b-86d1-70fb73e88187
// https://rpc-mainnet.suiscan.xyz:443
// https://cetus-suimain-e31f.mainnet.sui.rpcpool.com
// https://sui-rpc.publicnode.com

// mainnet
export const clmmSDKOption: SdkOptions = {
  ...
  clmm_pool: {
    ...
    // package_id: '0x70968826ad1b4ba895753f634b0aea68d0672908ca1075a2abdf0fc9e0b2fc6a',
    // published_at: '0x2891c6b8dca29a075d263c1bb21c7b88adf3ff6baddae1b8743cc00b66bd2c47',
    config: sdkConfig.clmmPoolConfig,
  },
  integrate: {
...
export const cetusClmmSDK = new CetusClmmSDK(clmmSDKOption)
